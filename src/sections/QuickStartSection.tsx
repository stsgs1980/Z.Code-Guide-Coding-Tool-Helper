/**
 * SECTIONS LAYER
 * QuickStartSection - quick start guide
 * 
...
const steps = [
  { icon: UserPlus, title: 'Зарегистрируйтесь', desc: 'Создайте аккаунт на z.ai' },
  { icon: Key, title: 'Получите API-ключ', desc: 'В панели управления создайте ключ' },
  { icon: Settings, title: 'Настройте инструмент', desc: 'Укажите Base URL и ключ' },
  { icon: Play, title: 'Начните кодить', desc: 'Запустите AI-ассистента' },
];
